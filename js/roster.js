...
GH.roster = (function () {
  ...
  R.PACKS = [
    { id: 'aile', name: 'AILE', glyph: '▲', css: '#80d8ff', accent: 0x60c8ff,
      ...
      stats: { speed: 1.12, maxHP: 0.92, armor: -1, crit: 2 }, weapon: { interval: 0.93 }, vector: 'bike' },
    { id: 'sword', name: 'SWORD', glyph: '⚔', css: '#ff9070', accent: 0xff6040,
      ...
      stats: { maxHP: 1.0, crit: 3 }, weapon: { damage: 1.15, range: 1.12, aoe: 1.1 } },
    { id: 'launcher', name: 'LAUNCHER', glyph: '◆', css: '#f0c060', accent: 0xf0a030,
      desc: 'Siege pack: layered plating and stabilisers. Tough and slow.',
      stats: { maxHP: 1.22, armor: 3, block: 3, speed: 0.9 }, weapon: { damage: 1.06 }, vector: 'tank' },
    { id: 'storm', name: 'STORM', glyph: '϶', css: '#c090ff', accent: 0xa060ff,
      ...
      stats: { crit: 6, maxHP: 0.96 }, weapon: { damage: 1.04 }, elemMult: 1.2 },
    { id: 'phantom', name: 'PHANTOM', glyph: '☾', css: '#9ae8c0', accent: 0x60e8a0,
      ...
      stats: { lifesteal: 5, crit: 4, speed: 1.05, maxHP: 0.94 }, weapon: { interval: 0.97 } }
  ];
  ...
  var RELICS = [
    { id: 'relic_moonlight', name: 'MOONLIGHT', icon: '☽', base: 'aegis', vector: 'disc', prop: 'sword',
      ...
      stats: { maxHP: 170, speed: 19, armor: 7, block: 18, crit: 14, lifesteal: 4 },
      weapon: { damage: 1.5, interval: 0.8, range: 1.25, knockback: 1.4 },
    ...
    { id: 'relic_ark', name: 'ARK HULL', icon: '⛫', base: 'titan', vector: 'tank', prop: 'mortar',
      ...
      stats: { maxHP: 260, speed: 12, armor: 14, block: 8, crit: 4, lifesteal: 0 },
      weapon: { damage: 1.6, interval: 0.9, aoe: 1.3 },
    ...
    { id: 'relic_corebreaker', name: 'COREBREAKER', icon: '⟁', base: 'fang', vector: 'bike', prop: 'claws',
      role: 'Relic frame · hype engine', model: { body: 0xc02030, accent: 0xffd040, dark: 0x301010, trim: 0xe08030 },
      stats: { maxHP: 130, speed: 21, armor: 3, block: 0, crit: 18, lifesteal: 8 },
      weapon: { damage: 1.7, interval: 0.95, range: 1.1 },
    ...
    { id: 'relic_seer', name: 'SEER', icon: '◎', base: 'hexen', vector: 'disc', prop: 'staff',
      ...
      stats: { maxHP: 120, speed: 18, armor: 3, block: 0, crit: 16, lifesteal: 0 },
      weapon: { damage: 1.35, interval: 0.75, homing: 2, aoe: 1.2 }, elemMult: 1.35,
    ...
    { id: 'relic_crimson', name: 'CRIMSON', icon: '☄', base: 'viper', vector: 'bike', prop: 'daggers',
      ...
      stats: { maxHP: 125, speed: 21, armor: 4, block: 2, crit: 24, lifesteal: 3 },
      weapon: { damage: 1.5, interval: 0.85 },
    ...
    { id: 'relic_keyhead', name: 'KEYHEAD', icon: '⌘', base: 'strix', vector: 'bike', prop: 'lance',
      role: 'Relic frame · spike-dock trainer', model: { body: 0x50c050, accent: 0xffffff, dark: 0x183018, trim: 0x90e090 },
      stats: { maxHP: 110, speed: 23, armor: 2, block: 6, crit: 22, lifesteal: 0 },
      weapon: { damage: 1.4, interval: 0.8, range: 1.15 },
    ...
    { id: 'relic_revenant', name: 'REVENANT-13', icon: '♆', base: 'morrow', vector: 'disc', prop: 'scythe',
      role: 'Relic frame · bio-organic', model: { body: 0x6040a0, accent: 0x60ff80, dark: 0x201040, trim: 0xa080e0 },
      stats: { maxHP: 150, speed: 18, armor: 5, block: 0, crit: 10, lifesteal: 20 },
      weapon: { damage: 1.55, interval: 0.85, range: 1.2 },
  ...
  RELICS.forEach(function (rl) {
    ...
    var def = {
      id: rl.id, lineage: 'relic', kind: 'relic', vector: rl.vector,
      name: rl.name, role: rl.role, icon: rl.icon, desc: rl.desc,
      model: { body: rl.model.body, accent: rl.model.accent, dark: rl.model.dark, trim: rl.model.trim, prop: rl.prop, pack: 'relic', mark: 4 },
      stats: rl.stats,
